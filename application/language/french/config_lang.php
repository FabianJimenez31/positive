...
$lang['config_backup_phpmyadmin_2'] = 'Le nom d\'utilisateur est root et le mot de passe est celui que vous avez utilisé lors de l\'installation initiale de Mercurio. Une fois connecté, sélectionnez votre base de données à partir du panneau sur la gauche. Ensuite, sélectionnez "export" et soumettre le formulaire.';
$lang['config_backup_control_panel'] = 'Si Mercurio à été installé sur un serveur disposant d\'un panneau de contrôle tel que cPanel, recherchez le module de sauvegarde qui vous permettra de télécharger des sauvegardes de votre base de données.';
