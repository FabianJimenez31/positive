...
$lang['config_backup_phpmyadmin_2'] = 'Ihr Benutzername ist <b>root</b> und das Passwort ist auf den Wert gesetzt, den Sie während der Installation von Mercurio angegeben haben. Wenn Sie angemeldet sind, wählen Sie Ihre Datenbank in dem Menü auf der linken Seite aus. Danach klicken Sie auf Export und senden dann das Formular ab.';
$lang['config_backup_control_panel'] = 'Falls Sie Mercurio auf einem eigenen Server installiert haben, der eine Systemsteuerung hat, wie z.B. cpanel, suchen Sie nach dem Backup-Modul, welches Ihnen meistens die Möglichkeit bietet, Backups Ihrer Datenbank herunterzuladen.';
