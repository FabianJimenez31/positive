...
$lang['config_backup_phpmyadmin_2'] = '您的用户名是root，密码是您在初始安装Mercurio时使用的。登录后，从左侧的面板中选择您的数据库。然后选择导出，然后提交表单。';
...
$lang['config_billing_is_managed_through_paypal'] = '帐单通过<a target="_blank" href="http://paypal.com"> Paypal </a>进行管理。您可以点击<a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_subscr-find&alias=BNTRX72M8UZ2E">此处</a>取消订阅。您可以<a href="http://mercurio.skyone.com.co/update_billing.php" target="_blank">在此更新结算</a>。';
