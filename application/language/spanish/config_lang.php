...
$lang['config_backup_phpmyadmin_2'] = 'Su nombre de usuario es root y la contraseña es la que se utilizó durante la instalación inicial de Mercurio. Una vez que se ha conectado, seleccione la base de datos desde el panel de la izquierda. A continuación, seleccione la exportación y luego envíe el formulario.';
