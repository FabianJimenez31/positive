	...
	function complete()
	{
		...
		foreach($data['cart'] as $linea=>$producto){
			...
			if($producto['is_service']==1 && $producto['is_osticket']==1){
				...
				$ostCampos=json_decode($producto['osticket_fields'],1);
				foreach($ostCampos as $ostcampo){

					if(strpos($ostcampo['value'],'customer') !== false && $ostcampo['required']!=false){

						if( $customer_id ==-1 ){

							if($ost_ERROR==''){

								$ost_ERROR=lang('common_customer')." ".lang('common_required');

							}

						}else{

							if($ostcampo['value']=='customer.account_number' && strlen($cust_info->account_number)<=0 ){

								if($ost_ERROR==''){

									$ost_ERROR=$ostcampo['label']." ".lang('common_required');

								}

							}elseif($ostcampo['value']=='customer.tax_certificate' && strlen($cust_info->tax_certificate)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.name' && strlen($cust_info->first_name.$cust_info->last_name)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.email' && strlen($cust_info->email)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.phone' && strlen($cust_info->phone_number)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.address_1' && strlen($cust_info->address_1)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.address_2' && strlen($cust_info->address_2)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.city' && strlen($cust_info->city)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.state' && strlen($cust_info->state)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.zip' && strlen($cust_info->zip)<=0 ){
							...
							}elseif($ostcampo['value']=='customer.country' && strlen($cust_info->country)<=0 ){
					...
					}elseif(strpos($ostcampo['value'],'manual') !== false && $ostcampo['required']!=false){

						if(strlen($producto['osf_'.$ostcampo['field']])<=0){
					...
					}elseif(strpos($ostcampo['value'],'employee') !== false && $ostcampo['required']!=false){


						if($ostcampo['value']=='employee.employee_number' && strlen($empleado_info->employee_number)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.name' && strlen($empleado_info->first_name.$empleado_info->last_name)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.email' && strlen($empleado_info->email)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.phone' && strlen($empleado_info->phone_number)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.address_1' && strlen($empleado_info->address_1)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.address_2' && strlen($empleado_info->address_2)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.city' && strlen($empleado_info->city)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.state' && strlen($empleado_info->state)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.zip' && strlen($empleado_info->zip)<=0 ){
						...
						}elseif($ostcampo['value']=='employee.country' && strlen($empleado_info->country)<=0 ){
		...
		redirect('sales/receipt/'.$sale_id_raw);
	}
