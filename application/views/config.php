...
<div class="config-panel">
	...
	function create_section($title, $doc = 'store-configuration-options', $section = '')
	{
		...
		return $title . ' ' ;
/**Eliminamos el Anchor de Sopirte**/
/**
. anchor_popup('https://support.mercurio.skyone.com.co/v'.
...
**/
	...
	<?php } ?>
				...
				<div class="panel-body">
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_auto_increment')) ?>">
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							'value'=>$this->config->item('item_id_auto_increment')));?>
						</div>
					</div>
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_auto_increment')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							'value'=>$this->config->item('item_kit_id_auto_increment')));?>
						</div>
					</div>
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_auto_increment')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							'value'=>$this->config->item('sale_id_auto_increment')));?>
						</div>
					</div>
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_auto_increment')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							'value'=>$this->config->item('receiving_id_auto_increment')));?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					<?php echo create_section("osTicket", 'store-ostickets-options', 'section-ostickets-information')  ?>
				</div>
				<div class="panel-body">

					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label("Host".':', 'osTicketsHost',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
							<?php echo form_input(array(
								'class'=>'validate form-control form-inps',
							'name'=>'osTicketsHost',
							'id'=>'osTicketsHost',
							'value'=>$this->config->item('osTicketsHost')));?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label("API-KEY".':', 'osTicketsAPI',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'osTicketsAPI',
							'id'=>'osTicketsAPI',
							'value'=>$this->config->item('osTicketsAPI')));?>
						</div>
					</div>
				</div>
			</div>	
			...
			if(update_available)
			{
				bootbox.confirm(<?php echo json_encode(lang('common_update_available')); ?>, function(response)
				{
					if (response)
					{
						...
						window.location="http://mercurio.skyone.com.co/downloads.php";
					}
				});
			}
			else
