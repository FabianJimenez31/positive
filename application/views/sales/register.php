									  ...
									  <dd>
										...
										<?php
											...
											if($item['is_service']==1 && $item['is_osticket']==1){
												...
												$campos=json_decode($item['osticket_fields'],1);

												foreach($campos as $osf){

													if($osf['value']=='manual.input'){

														?>

														<dt><?php echo $osf['label']; ?></dt>

														<dd><a href="#" id="osf_<?php echo $osf['field']; ?>_<?php echo $line;?>" class="xeditable" data-type="text" data-pk="1" data-name="osf_<?php echo $osf['field']; ?>" data-value="<?php echo H($item['osf_'.$osf['field']]); ?>" data-url="<?php echo site_url('sales/edit_item/'.$line); ?>" data-title="<?php echo H($osf['label']); ?>"><?php echo character_limiter(H($item['osf_'.$osf['field']]), 100); ?></a></dd>
