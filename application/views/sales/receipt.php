			                ...
			                <div class="invoice-content invoice-con">
			                    <div class="invoice-content-heading"><?php echo $item['name']; ?><?php if ($item_number_for_receipt){ ?> - <?php echo $item_number_for_receipt; ?><?php } ?><?php if ($item['size']){ ?> (<?php echo $item['size']; ?>)<?php } ?>
			                    	...
			                    	<div class="invoice-desc">
										...
										<?php
											if($item['is_osticket']==1){
											$osTelementos=json_decode($item['osticket_fields'],1);
											$osTpreload=json_decode($item['__osTPreload__'],1);

												foreach($osTelementos as $elemOST){

													?>

			                    	<div class="invoice-desc">

										<b><?php echo $elemOST['label']; ?>:</b> <?php echo (isset($osTpreload[$elemOST['field']]))?$osTpreload[$elemOST['field']]:'-'; ?>
			                    	...
			                    	<div class="invoice-desc">
										...
										<b><?php echo lang('common_receipt_sent'); ?>:</b> <?php echo $item['__osTPreloadX__']; ?>
