...
<!-- AQUI AVISA DE LA LICENCIA-->
<!--
<div class="row add-location-link">
	<div class="col-md-12 text-center">
		<?php if (!is_on_demo_host()) { ?>
			<div class="alert alert-info" role="alert"><?php echo lang('locations_adding_location_requires_addtional_license'); ?>: <strong><a href="http://mercurio.skyone.com.co/buy_additional.php" target="_blank"><?php echo lang('locations_purchase_additional_locations'); ?></a></strong></div>
		<?php } ?>
	</div>
</div>
--->
		...
		bootbox.confirm({
	      ...
	      cancel: {
			...
			callback: function(result)
			{
				if (result)
				{
					window.location='http://mercurio.skyone.com.co/buy_additional.php';
				}
				else
				{
