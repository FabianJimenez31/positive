		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-body">
					<h3 style="margin-left: 80px;"><a href="http://mercurio.skyone.com.co/buy_additional.php" target="_blank"><?php echo lang('locations_purchase_additional_licenses'); ?> &raquo;</a></h3>
			...
			<div class="col-md-12">				
				<div class="panel panel-piluku">
					...
					<div class="form-group">	
						...
						<div class="form-group">
							<?php echo form_label("<a href='https://www.vantiv.com/' target='_blank'>".lang('locations_enable_credit_card_processing').'</a>:', 'enable_credit_card_processing',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
				...
				{ebt_integrated:ebt_integrated, terminal_id: terminal_id_0, secure_device_override_emv: secure_device_override_emv, secure_device_override_non_emv: secure_device_override_non_emv, credit_card_processor: credit_card_processor, emv_merchant_id: emv_merchant_id, com_port: com_port, listener_port:listener_port, net_e_pay_server:net_e_pay_server}, function(response) {
					...
					if(response.success)
					{
				   	...
				   	data['MerchantID'] = emv_merchant_id;
						...
						if (terminal_id_0)
						{
					   	data['TerminalID'] = terminal_id_0;
						}
						
						emv_param_download(<?php echo json_encode($emv_param_download_init_params['post_host']); ?>, listener_port, data, <?php echo json_encode(lang('locations_init_device_success')); ?>, <?php echo json_encode(lang('locations_unable_to_init_device'));?>, function()
						{
							$("#ajax-loader").hide();
