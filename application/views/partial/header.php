...
<head>
    ...
    <title><?php 
		 ...
		 echo !is_on_demo_host() ?  $company.' -- '.lang('common_powered_by').' Mercurio' : 'Demo - Mercurio' ?></title>
				...
				<nav class="navbar navbar-default top-bar">
					...
					<?php } ?>
						...
						<li class="dropdown">
							...
							<!--<li>
									<a tabindex = "-1" id="support_link" target="_blank" href="http://support.mercurio.skyone.com.co/"><i class="ion-help-buoy"></i><span class="text"><?php echo lang('common_support'); ?></span></a>									
							</li>-->
