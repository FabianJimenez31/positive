			...
			<div id="footers" class="col-md-12 hidden-print text-center">
				<?php /*echo lang('common_please_visit_my'); ?> 
					<a tabindex="-1" href="http://mercurio.skyone.com.co" target="_blank"><?php echo lang('common_website'); ?></a> <?php echo lang('common_learn_about_project');*/ /*AQUI QUITAMOS EL LINK A PHPPOS*/ ?>.
